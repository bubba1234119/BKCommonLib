...
public class CommonMinecartTNT extends CommonMinecart<ExplosiveMinecart> {
	 ...
	 * The velocity of the Minecart is used to compute the yield modifier.
	 */
	public void explode() {
	...
	/**
	 * Sets the fuse to the initial tick time and plays the detonation animation/sound.
	 */
	...
	/**
	 * Gets whether this TNT Minecart is moving fast.
	 * When moving at this speed, colliding with things will result in detonation.
	 * 
	...
	/**
	 * Gets the amount of ticks until this TNT Minecart will explode.
	 * A value of -1 indicates that the TNT is not yet detonated.
	 * 
	 * @return fuse ticks
	 */
