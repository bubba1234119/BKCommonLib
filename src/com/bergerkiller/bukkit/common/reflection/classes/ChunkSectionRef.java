...
public class ChunkSectionRef {
	...
	private static final MethodAccessor<Void> setData = TEMPLATE.getMethod("setData", int.class, int.class, int.class, IBlockData.class); //"setData", int.class, int.class, int.class, int.class);
